...
if __name__ == '__main__':
    ## Configs
    in_format = '../../../data/sdss-galaxyzoo/des_overlap/images/raw/' \
              + 'run{run}-rerun{rerun}-camrol{camcol}-field{field}-{filter}.fits'
    out_dir = '../../../data/sdss-galaxyzoo/des_overlap/images/clipped/'
    galaxy_ds_path = '../../../data/sdss-galaxyzoo/des_overlap/merged_dataset.csv'
