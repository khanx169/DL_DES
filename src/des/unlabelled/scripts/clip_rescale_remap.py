...
if __name__ == '__main__':
    ...
    des_image_path = PATH + 'data/des/unlabelled/raw/{tilename}_*_{band}.fits.fz'
    out_dir = PATH + 'data/des/unlabelled/images/'


    for i in merged_cm.index :

        tilename = merged_cm['TILENAME'][i]
        COADD_OBJECT_ID = merged_cm['COADD_OBJECT_ID'][i]
