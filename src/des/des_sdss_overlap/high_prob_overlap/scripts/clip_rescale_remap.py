...
if __name__ == '__main__':
    ...
    merged_cm = high_prob_crossmatch_test_set
    ...
    des_image_path = PATH + 'data/des/des_sdss_overlap/high_prob_overlap/raw/{tilename}_*_{band}.fits.fz'
    out_dir = PATH + 'data/des/des_sdss_overlap/high_prob_overlap/images/'
